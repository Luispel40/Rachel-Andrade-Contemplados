document.addEventListener("DOMContentLoaded", async function () {
  ...
  const tabelaDados = linhas.map((line) =>
    ...
    //transforma as entradas em entradas com 3% de aumento
    $("td:nth-child(6)").each(function () {
      ...
      var newValue = parseFloat(value) + (cell * 0.03); // Adiciona 3% do valor do crédito ao valor
    ...
    function adicionarClassesTabela() {
      ...
      $("tr").each(function () {
        ...
        if (primeiraCelula.text().replace(/\s+/g, "") == "Imovel") {
          primeiraCelula.html(`<i class="fa-solid fa-home"></i>`);
